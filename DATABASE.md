...
- `monitoraggio_pit`: id, gara_id, iscritto_gara_id, kart_lasciato_id, kart_preso_id, fila_colore, timestamp, stato
- `file_pit_gara`: id, gara_id, nome_colore, colore_hex, ordine
